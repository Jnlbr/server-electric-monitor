...
drop index fk_user_license_ref_license_fk;

drop index core_app_user_pk;

drop table core_app_user;

drop index dk_device_ref_level_fk;

drop index fk_device_ref_license_fk;

drop index fk_device_ref_device_type_fk;

drop index core_device_pk;

drop table core_device;

drop index core_device_type_pk;

drop table core_device_type;

drop index fk_level_ref_license_fk;

drop index fk_level_ref_level_fk;

drop index core_level_pk;

drop table core_level;

drop index core_license_pk;

drop table core_license;

drop index fk_device_current_ref_device_fk;

drop index main_device_current_pk;

drop table main_device_current;

drop index fk_device_not_ref_device_type;

drop index fk_device_not_ref_not_fk;

drop index main_device_notification_pk;

drop table main_device_notification;

drop index fk_device_preference_ref_device;

drop index fk_device_pref_ref_app_user;

drop index core_device_preference_pk;

drop table main_device_preference;

drop index fk_not_pref_ref_device_pref;

drop index fk_not_pref_ref_device_not;

drop index main_notification_prefence_pk;

drop table main_notification_prefence;

drop index main_notification_type_pk;

drop table main_notification_type;

drop domain basic_status;
...
drop domain long_string;

drop domain medium_string;

drop domain short_string;

drop domain "timestamp";

drop domain very_long_string;

drop sequence core_app_user_seq;

drop sequence core_device_seq;

drop sequence core_device_type_seq;

drop sequence core_level_seq;

drop sequence core_license_seq;

drop sequence main_device_current_seq;

drop sequence main_device_notification_seq;

drop sequence main_device_preference_seq;

drop sequence main_notification_prefence_seq;

drop sequence main_notification_type_seq;
...
create sequence main_notification_prefence_seq
increment 1
start 0;
...
/* Domain: codes                                                */
/*==============================================================*/
create domain codes as VARCHAR(512);
